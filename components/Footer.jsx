...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-8 relative">
      <div className="container mx-auto py-0 mt-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-gray-400">Address: test-00001, test address, surat-00000,
            </p>
            <p className="text-gray-400">Email: test@gmail.com</p>
            <p className="text-gray-400">Phone: +91 0123456789</p>
          </div>
        </div>
        <div className="border-t border-gray-700 mt-8 pt-5 flex flex-col md:flex-row justify-between items-center max-h-1">
          <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} Design Studio. All rights reserved.</p>
